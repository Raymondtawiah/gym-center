<x-layouts::app-main title="Renew Membership - GymCenter">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Back Link -->
        <a href="{{ route('admin.bookings.show', $booking) }}" class="inline-flex items-center gap-2 text-sm text-zinc-400 hover:text-white transition-colors mb-6">
        ...
        <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 mb-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div class="bg-zinc-800/50 rounded-xl p-4">
                    <p class="text-xs text-zinc-500 mb-1">Member</p>
            ...
            <div class="p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('admin.bookings.renew.store', $booking) }}">
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="notes" id="notes" rows="3" placeholder="Add any notes about this renewal..."
                            class="w-full px-4 py-2.5 bg-zinc-800 border border-zinc-700 rounded-xl text-white text-sm placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none">{{ $booking->notes }}</textarea>
                    </div>

                    <!-- Actions -->
                    <div class="flex justify-end gap-3 pt-4 border-t border-zinc-800">
                        <a href="{{ route('admin.bookings.show', $booking) }}" class="px-5 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-sm font-medium rounded-xl transition-colors">
                            Cancel
                        </a>
